...
interface SimpleWorkflowListProps {
...
const SimpleWorkflowList: React.FC<SimpleWorkflowListProps> = ({ onEdit, onView }) => {
  ...
  const handleCreate = async (values: any) => {
    try {
      await workflowApi.create(values as WorkflowCreateRequest);
    ...
    },
    {
      ...
      render: (_: any, record: Workflow) => (
        <Space size="small">
          ...
          <Button type="link" icon={<PlayCircleOutlined />} onClick={() => handleDemo(record)}>
            演示
          </Button>
          <Popconfirm
            title="确定要删除？"
